      ...
      <div className="relative container mx-auto px-4 py-24 sm:py-32">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <h1 className={`text-4xl lg:text-5xl xl:text-6xl font-bold font-display leading-tight ${
              ...
              >
                ...
                With expertise in modern web technologies and a keen eye for detail, I build 
              ...
              >
                <motion.a
                  href="#projects"
                  className={`group inline-flex items-center justify-center px-6 py-3 rounded-xl text-base font-medium transition-all duration-300 ${
                    isDark 
        ...
        >
          <ChevronDown className={`w-6 h-6 ${
            isDark ? 'text-dark-100' : 'text-gray-400'
          } animate-bounce-slow`} />
        </motion.div>
      </div>
    </div>
